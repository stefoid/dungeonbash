...
public class CreatureListElementView implements IListElement {
	...
	public CreatureListElementView(UIDepend gui, CreatureStats stats, Rect area) {
		...
		healthText = new TextView(gui,null, new String(stats.health+"/"+stats.maxHealth), textArea, HAlignment.CENTER, VAlignment.CENTER, Color.RED);
		...
		magicText = new TextView(gui,null, new String(stats.magic+"/"+stats.maxMagic), textArea, HAlignment.CENTER, VAlignment.CENTER, new Color(0f, 0f, 1f, 1));
