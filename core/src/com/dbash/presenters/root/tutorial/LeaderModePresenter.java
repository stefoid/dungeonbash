...
public class LeaderModePresenter extends TutorialPopupPresenter implements TouchEventListener {
	...
	public void start(Rect theArea, TouchEventProvider touchEventProvider) {
		...
		this.fadeBox = new FadeBoxPresenter("Use leader mode to move all characters when no monsters are around.\nTest leader mode button now.", 
	...
	private void addMoreFaderBoxes() {
		FadeBoxPresenter fb1 = new FadeBoxPresenter("When you swipe to move your leader, where your finger lifts off sets a target the leader will go to.", 
				HAlignment.CENTER, VAlignment.BOTTOM, null);
		addFadeBoxSeq(fb1);
