...
public class TurnProcessor implements IPresenterTurnState {
	...
	private List<Character> createRandomCharacters() {
		...
		if (L.TESTCHARS) {
			...
			theChars.add(new Character(Creature.getIdForName("dwarf"), p, 2, dungeonEvents, dungeonQuery, this));
			theChars.add(new Character(Creature.getIdForName("dwarf"), p, 3, dungeonEvents, dungeonQuery, this));
