...
public class TurnProcessor implements IPresenterTurnState {
	...
	private List<Character> createRandomCharacters() {
		...
		theChars.clear();
		p.level = 20;
		theChars.add(new Character(Creature.getIdForName("titan"), p, 1, dungeonEvents, dungeonQuery, this));
		...
		c.addAbility(new Ability(Ability.getIdForName("amulet: speed"), null, 20, dungeonEvents, dungeonQuery));
