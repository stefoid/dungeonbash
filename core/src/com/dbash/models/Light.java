...
public class Light {
	...
	public static float MAX_DETECT_LIGHT = 2.5f;
	...
	public static float CENTRAL_TORCH_STRENGTH = 3f;
	public static float PERIPHERAL_TORCH_STRENGTH = .9f;
	public static float EXIT_LIGHT_STRENGTH = 0.4f;
	...
	public Light(DungeonPosition position, int range, float strength, boolean permanent, boolean visibleOnLightMap, boolean affectsStealth) {
		...
		this.visibleOnLightMap = visibleOnLightMap;
		this.affectsStealth = affectsStealth;
	}
